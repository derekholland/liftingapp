...
export default function MainPage() {
	...
	// Fetch workouts when the component mounts
	useEffect(() => {
		fetchWorkouts(); // Only fetch data on component mount
	}, []);

	// Function to reload the page after a workout update, addition, or deletion
	const handleUpdate = () => {
		window.location.reload(); // Reload the page after specific actions
	};
